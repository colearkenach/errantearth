...
EE.SKILL_LIST = [
  ...
  { key: "hthAikido",              name: "Hand to Hand: Aikido",                group: "Physical", base: 0, perLvl: 0, statBonuses: { me: { formula: "1d4" }, pp: { bonus: 1 }, pe: { bonus: 1 }, sdc: { formula: "2d6" } } },
  { key: "hthJudo",                name: "Hand to Hand: Judo",                  group: "Physical", base: 0, perLvl: 0, statBonuses: { me: { bonus: 1 }, pp: { bonus: 1 }, sdc: { formula: "2d4" } } },
  { key: "hthJujitsu",             name: "Hand to Hand: Jujitsu",               group: "Physical", base: 0, perLvl: 0, statBonuses: { ps: { bonus: 2 }, pp: { bonus: 1 }, sdc: { formula: "3d6" } } },
  { key: "hthKarate",              name: "Hand to Hand: Karate",                group: "Physical", base: 0, perLvl: 0, statBonuses: { ps: { formula: "1d4" }, pe: { bonus: 2 }, spd: { bonus: 2 }, sdc: { formula: "3d6" } } },
  { key: "hthKendo",               name: "Hand to Hand: Kendo",                 group: "Physical", base: 0, perLvl: 0, statBonuses: { ps: { bonus: 1 }, pp: { bonus: 1 }, spd: { bonus: 2 }, sdc: { formula: "2d4" } } },
  { key: "hthNinjitsu",            name: "Hand to Hand: Ninjitsu/Tai-Jutsu",    group: "Physical", base: 0, perLvl: 0, statBonuses: { ma: { bonus: 2 }, ps: { bonus: 1 }, pe: { bonus: 1 }, pp: { bonus: 1 }, spd: { bonus: 4 } } },
  { key: "hthSamurai",             name: "Hand to Hand: Samurai",               group: "Physical", base: 0, perLvl: 0, statBonuses: { me: { bonus: 2 }, pp: { bonus: 2 }, pe: { bonus: 1 }, sdc: { formula: "3d6" } } },
  { key: "hthTengJutsu",           name: "Hand to Hand: Teng-Jutsu",            group: "Physical", base: 0, perLvl: 0 },
